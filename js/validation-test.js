...
console.log("storage-browser.js Größe:", $(wc -l < js/storage-browser.js), "Zeilen (erwartet ~300)");
console.log("hangar-events.js Größe:", $(wc -l < js/hangar-events.js), "Zeilen (erwartet ~400)");
