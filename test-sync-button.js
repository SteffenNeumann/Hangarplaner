...
function testAllStatusCombinations() {
	...
	testCases.forEach((testCase, index) => {
		setTimeout(() => {
			console.log(`\n🧪 Test ${index + 1}: ${testCase.mode} ${testCase.indicator || "normal"}`);
			
			window.sharingManager.updateSyncStatusDisplay(testCase.mode, testCase.active);
...
console.log("Führe testAllStatusCombinations() aus, um alle Kombinationen zu testen");
